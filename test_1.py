...
#
# # 运动到指定位置函数************************************
# ro.set_position(tip_x_y_z=[0, 0, -220], speed=1, acceleration=1)
# # *********************************************************
#
# # 运动到相对位置函数*****************************************
...
# #
# #
# pl_list = draw_rectangle(pl=[-30, 30, -255], l=60, h=60) #
...
#
# for i in range(20):
#     pl_list = draw_ellipse(pl=[50, 0, -255], a=50, b=80 - i * 3)  # 求点
#     ro.set_positions_curve_pre(tip_x_y_zs=pl_list)  # 预设机械臂末端轨迹函数
#     ro.set_positions_curve_start_point(10)  # 运动到轨迹起始位置函数
#     ro.detect_position()
...
# 控制机器人关节角度函数*******************************************
# ro.set_joints(angle_list=[0, 0, 0], speed=10)
# *********************************************************
...
# print(dr.get_angle(1))
# print(dr.get_angle(2))
# print(dr.get_angle(3))
# ro.detect_joints()

# dr.step_angle(0, 10.37, 10, 10, 1)
