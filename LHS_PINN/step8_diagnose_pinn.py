...
# ================= 配置 =================
FILE_TARGETS = "points_with_compensation.csv" # 包含 orig_x, orig_y, orig_z
FILE_MEASURED_RAW = "validation_500.csv"      # 跟踪仪导出的原始数据
...
def main():
    print("="*60)
    print("   Step 8 Diagnosis: PINN 验证报告")
    print("="*60)
    ...
    # 左图: Error vs Radius
    title_1 = f"PINN Compensated: Error vs Radius\nMax: {max_err:.3f} mm (R={radii[idx_max]:.1f})"
    ...
    # ================== 保存图片代码 ==================
    save_file = "PINN_Final_Report.png"
